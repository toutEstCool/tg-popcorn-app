        ...
        <section className={s.bigTile}>
          <div className={s.bigTileInfoWrapper}>
            <img
              ...
              alt="Попкорн"
            />
            <span className={s.bitTileTitle}>Имя ведущего лекцию</span>
            <span className={s.bitTileActionText}>
              Дополнительный текст дополнительный текст
            </span>
          </div>
          <div>
            <button className={s.bitTileActionBtn} onClick={navigateOnLecture}>
              Перейти к лекциям
            </button>
          </div>
        </section>
